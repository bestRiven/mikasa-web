						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="alert alert-info" >
									...
									门店ID:
									<input id="app_poi_code" type="text" class="" placeholder="请输入门店ID" />
										&nbsp;&nbsp;&nbsp;&nbsp;
									库房编码:
									<input id="wma_store_code" type="text" class="" placeholder="请输入库房编码" />
										&nbsp;&nbsp;&nbsp;&nbsp;
									TMS编码:
									<input id="tms_store_code" type="text" class="" placeholder="请输入TMS编码" />
										&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					url: "${ctx}/eleme/store/getList.do",
					datatype: "json",
					mtype: "GET",
					height: 500,
					colNames:['ID','门店ID','库房编码','TMS编码','操作'],
					colModel:[
						...
						{name:'wma_store_code',index:'wma_store_code',search:false,sortable:false,editable: true},
						{name:'tms_store_code',index:'tms_store_code',search:false,sortable:false,editable: true},
					...
					editurl: "${ctx}/eleme/store/update.do",
					caption: "门店关系列表",
					autowidth: true
				...
				$("#find_btn").click(function(){ 
			        ...
			        var wma_store_code = $("#wma_store_code").val();
			        var tms_store_code = $("#tms_store_code").val();
			        jQuery(grid_selector).jqGrid('setGridParam',{
			            url:"${ctx}/eleme/store/getList.do",
			            postData:{  'app_poi_code':app_poi_code,
					            	'wma_store_code':wma_store_code,
					            	'tms_store_code':tms_store_code} //发送数据 
