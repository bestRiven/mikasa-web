						...
						<div class="row" >
								...
								<div class="alert alert-info" >
									...
									<input id="app_poi_code" type="text" class="" placeholder="请输入供门店ID" />
										&nbsp;&nbsp;&nbsp;&nbsp;
									收货人:
									<input id="recipient_name" type="text" class="" placeholder="请输入收货人" />
										&nbsp;&nbsp;&nbsp;&nbsp;
									无坐标:
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					url: "${ctx}/order/getList.do",
					datatype: "json",
					mtype: "GET",
					height: 500,
					colNames:['订单号','展示订单号','下单时间','金额','门店ID','门店名称','门店电话','收货人','收货人电话','收货地址'],
					colModel:[
						{name:'order_id',index:'order_id',search:false,sortable:false},
						{name:'wm_order_id_view',index:'wm_order_id_view',search:false,sortable:false},
						{name:'created_at',index:'created_at',search:false,sortable:false,width:180,
							formatter:'date',
							formatoptions:{srcformat: 'Y-m-d H:i:s', newformat: 'Y-m-d H:i:s'}},
						{name:'total',index:'total',search:false,sortable:false},
						{name:'app_poi_code',index:'app_poi_code',search:false,sortable:false},
						{name:'wm_poi_name',index:'wm_poi_name',search:false,sortable:false},
						{name:'wm_poi_phone',index:'wm_poi_phone',search:false,sortable:false},
						{name:'recipient_name',index:'recipient_name',search:false,sortable:false},
						{name:'recipient_phone',index:'recipient_phone',search:false,sortable:false},
						{name:'recipient_address',index:'recipient_address',search:false,sortable:false}
					], 
					...
					//editurl: '<s:url value="/presale/SkuPreSaleAction/query.action"/>',//$path_base+"/dummy.html",//nothing is saved
					caption: "订单查询列表",
					autowidth: true
